...
namespace Nativephp\OtpAutofill\Commands;

use Native\Mobile\Plugins\Commands\NativePluginHookCommand;

/**
 * Copy assets hook command for OtpAutofill plugin.
 *
...
{
    protected $signature = 'nativephp:otp-autofill:copy-assets';

    protected $description = 'Copy assets for OtpAutofill plugin';
    ...
    protected function copyAndroidAssets(): void
    {
        ...
        $this->info('Android assets copied for OtpAutofill');
    }
    ...
    protected function copyIosAssets(): void
    {
        ...
        $this->info('iOS assets copied for OtpAutofill');
    }
}